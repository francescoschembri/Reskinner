...
Bone::Bone(const std::string& name, const int ID, const aiNodeAnim* channel, const glm::mat4& offset)
	:
	m_Name(name),
	m_ID(ID),
...
const glm::mat4& Bone::GetLocalTransform() const { return m_LocalTransform; }
const glm::mat4& Bone::GetOffset() const { return offset; }
